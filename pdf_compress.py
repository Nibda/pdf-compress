...
def save_resuts(filename: str, pdf_out: object, pilobjects: list) -> str:
...
def main():
    ...
    for filename in get_filenames():
        start = time.time()
        size_in = round(os.path.getsize(filename), 2)
        ...
        try:
            fileout = save_resuts(filename, pdf_out, pilobjects)
        ...
        print("Input size: {} Kb, \toutput size: {} Kb".format(size_in / 1000, size_out / 1000))
        print('-'*50)        
